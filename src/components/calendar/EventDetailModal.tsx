    ...
    >
      ...
      >
        <div className="mb-3 flex items-start justify-between gap-3">
          <div className="flex min-w-0 flex-1 justify-between gap-2 font-[family-name:var(--font-mono)] text-xs text-[var(--muted)]">
        ...
        {description ? (
          <p className="mt-3 whitespace-pre-wrap font-[family-name:var(--font-body)] font-light text-sm leading-relaxed text-[var(--muted2)]">
            {description}
          </p>
        ) : null}
        {location ? (
          <p className="mt-3 font-[family-name:var(--font-body)] font-light text-sm text-[var(--muted2)]">
            📍 {location}
          </p>
        ) : null}
      </div>
